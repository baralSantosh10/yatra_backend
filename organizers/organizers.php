...
$sql = "SELECT organizers.*, users.name, users.email, users.contact FROM organizers inner join users where users.userId = organizers.userId";
...
if (!empty($filterName) || !empty($filterEmail)) {
    ...
    if (!empty($filterName)) {
        $conditions[] = "organizers.name LIKE '%$filterName%'";
    }

    if (!empty($filterEmail)) {
        $conditions[] = "organizers.email LIKE '%$filterEmail%'";
    }
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Organizer List</h3><br>
                                    ...
                                    <table class="table table-bordered table-responsive">
                                        ...
                                        <tbody>
                                            <?php while ($row = $result->fetch_assoc()) { ?>
                                                <tr>
                                                    <td>
                                                        <?php echo $row['organizerId']; ?>
                                                    </td>
                                                    <td><img src="<?php echo $img_base . $row['display_image']; ?>"
                                                    ...
                                                    <td>
                                                        <?php echo $row['eventCount']; ?>
                                                    </td>

                                                    <td>
                                                        <a href="edit.php?organizerId=<?php echo $row['organizerId']; ?>"
                                                            class="btn btn-sm btn-primary">Edit</a>
                                                        <a href="delete.php?organizerId=<?php echo $row['organizerId']; ?>"
