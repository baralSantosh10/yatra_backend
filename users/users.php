                                ...
                                <div class="card-body">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="type" name="type">
                                                        ...
                                                        <option value="user"
                                                            <?php if ($type == 'user') echo 'selected'; ?>>User
                                                        </option>
                                                        <option value="admin"
                                                            <?php if ($type == 'admin') echo 'selected'; ?>>Admin
                                                        </option>
                                                        <option value="organizer"
                                                             <?php if ($type == 'organizer') echo 'selected'; ?>>Organizer
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <nav aria-label="Pagination">
                                        <ul class="pagination justify-content-center">
                                            ...
                                            <li class="page-item">
                                                <a class="page-link"
                                                    href="?page=<?php echo $page - 1; ?>&name=<?php echo $name; ?>&email=<?php echo $email; ?>&userType=<?php echo $type; ?>"
                                                    aria-label="Previous">
                                            ...
                                            <li class="page-item <?php echo $i == $page ? 'active' : ''; ?>">
                                                <a class="page-link"
                                                    href="?page=<?php echo $i; ?>&name=<?php echo $name; ?>&email=<?php echo $email; ?>&userType=<?php echo $type; ?>">
                                                    <?php echo $i; ?>
                                                </a>
                                            </li>
                                            <?php endfor; ?>
